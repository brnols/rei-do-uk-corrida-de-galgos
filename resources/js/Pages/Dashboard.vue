  ...
  <q-page class="container">
    ...
    <div class="c-FormWrapper relative rounded-3xl p-2">
      <q-card class="rounded-3xl p-4 lg:mt-32 bg-light">
        <q-form
          ...
          class="flex flex-col lg:flex-row lg:flex-nowrap gap-3"
        >
          <!-- Pista -->
    ...
    <q-card class="rounded-3xl bg-light p-4 mt-7">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        >
          <div
            class="flex gap-1 items-center small text-dark whitespace-nowrap"
          >
...
export default {
  ...
  methods: {
    submit: function () {
      this.$inertia.get(
        this.route("dashboard", { pista: this.form.pista }),
        {
          race: this.form.race,
        },
        {
